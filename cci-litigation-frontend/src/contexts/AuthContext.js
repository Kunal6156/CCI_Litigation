...
export const AuthProvider = ({ children }) => {
    ...
    const login = async (credentials) => {
        ...
        try {
            ...
            const loginData = {
                username: credentials.username || credentials.email, // Backend expects 'username' field
                password: credentials.password,
                department_name: credentials.department_name
            };

            // If logging in with email, still use 'username' field as your backend handles both
